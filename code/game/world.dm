...
/world/New()
	...
	SetupLogs()
	load_poll_data()
	send2chat("<@&1209801976666263562> New round starting! Join at <byond://moviesfreepremium.xyz:1545>", "new-round-ping")
...
/world/proc/update_status()
	...
	s += " ("
	s += "<a href=\"https://discord.com/invite/x66MhM738t\">" //Change this to wherever you want the hub to link to.
