...
/datum/map_config
	// Metadata
	var/config_filename = "_maps/drought.json"
	...
	// Config actually from the JSON - should default to Drought
	var/map_name = "Drought"
	var/map_path = "map_files/Drought"
	var/map_file = "Drought.dmm"
